...
- [ ] #2 Covers documentation structure patterns
- [ ] #3 Covers example creation best practices
- [ ] #4 Covers changelog formatting
- [ ] #5 Assets contain documentation templates
- [ ] #6 References contain style guide
<!-- AC:END -->
